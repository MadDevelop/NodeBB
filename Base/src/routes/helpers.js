...
helpers.setupPageRoute = function (router, name, middleware, middlewares, controller) {
	middlewares = [middleware.maintenanceMode, middleware.registrationComplete, middleware.rsPeerLogin, middleware.pageView, middleware.pluginHooks].concat(middlewares);
